  ...
  return (
    <div>
      ...
      <section className="hero bg-green-300 text-center p-10">
          ...
          <p className="mt-2 text-lg">Ahmad Wafi lahr di Bandung, 07 Februari 2005. Ia merupakan anak pertama dari tiga bersaudara.
            ...
            sebagai mahasiswa jurusan Informatika.
          </p>
        </section>
        ...
        <section className="minatbakat p-10">
          ...
          <p className="text-lg">Sejak kecil Ia memiliki ketertarikan yang besar dengan pelajaran biologi dan
            berbagai perangkat elektronik di sekitarnya. Seringkali Ia menghabiskan waktu untuk mengotak atik hal-hal
            tersebut </p>
        </section>
